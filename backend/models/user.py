...
class User(Base, TimestampMixin):
    ...
    Attributes:
        ...
        public_key_id: Reference to active post-quantum public key
    """
    ...
    public_key_id: Mapped[Optional[uuid.UUID]] = mapped_column(
        UUID(as_uuid=True),
        ForeignKey("user_keys.key_id", use_alter=True),
        nullable=True,
        unique=True,
        comment="References active post-quantum public key"
    )
    
    # Relationships
    # user_keys: Mapped[list["UserKey"]] = relationship("UserKey", back_populates="user")
    # conversations: Mapped[list["Conversation"]] = relationship("Conversation", back_populates="created_by")
